...
public interface IInquirer
{
    ...
    Task<string> Password(string q, string? help = null);
    Task<string> Select(SelectQ q);
    Task<string> Select(string q, string[] options, string? help = null);
    Task<string> Text(TextQ q);
    Task<string> Text(string q, string? help = null);
    Task<DateOnly> DateSelect(DateQ q);
    Task<DateOnly> DateSelect(string question, string? help = null);
}
