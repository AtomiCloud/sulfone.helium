from api.core.core_mapper import AnswerMapper, QuestionMapper, CyanMapper
from api.template.req import TemplateAnswerReq, TemplateValidateReq
from api.template.res import TemplateRes, TemplateQnARes, TemplateFinalRes
from domain.template.input import TemplateInput, TemplateValidateInput
from domain.template.output import TemplateOutput, is_qna, is_final
