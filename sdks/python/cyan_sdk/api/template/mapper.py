from cyan_sdk.api.core.core_mapper import AnswerMapper, QuestionMapper, CyanMapper
from cyan_sdk.api.template.req import TemplateAnswerReq, TemplateValidateReq
from cyan_sdk.api.template.res import TemplateRes, TemplateQnARes, TemplateFinalRes
from cyan_sdk.domain.template.input import TemplateInput, TemplateValidateInput
from cyan_sdk.domain.template.output import TemplateOutput, is_qna, is_final
